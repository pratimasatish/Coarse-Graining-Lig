...
#     print start
    for j in range(12):
        print "{:d} {:d} {:2.5f} {:2.5f} {:2.5f}".format( int(data[start+j][0]),int(data[start+j][1]),data[start+j][2],data[start+j][3],data[start+j][4] )
    ...
    for j in range(12):
        print "{:d} {:d} {:2.5f} {:2.5f} {:2.5f}".format( int(data[start+j+size/2][0]), int(data[start+j+size/2][1]),data[start+j+size/2][2],data[start+j+size/2][3],data[start+j+size/2][4] )
